...
class GroupedCheckbox extends StatefulWidget {
  ...
  late final CheckboxOrientation orientation;
  ...
  late final MaterialTapTargetSize materialTapTargetSize;
  ...
  GroupedCheckbox({
    ...
    this.wrapTextDirection = TextDirection.ltr,
...
class _GroupedCheckboxState extends State<GroupedCheckbox> {
  ...
  Widget item(int index) {
    var bools = (widget.disabled != null &&
